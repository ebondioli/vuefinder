      ...
      <div draggable="true"
          ...
          <div>
            <div class="relative">
              ...
              <video muted loop class="h-10 md:h-12 m-auto" v-else-if="(item.mime_type ?? '').startsWith('video')" @mouseenter="playVideoPreview" @mouseleave="pauseVideoPreview" :alt="item.basename">
                <source :src="app.requester.getPreviewUrl(app.adapter, item)" type="video/mp4" />
              </video>

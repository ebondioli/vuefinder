<template>
  <div class="border-neutral-300 flex justify-between items-center py-1 text-sm">
    <div class="flex text-center" v-if="!searchQuery.length">
      <div class="mx-1.5" :aria-label="t('New Folder')" data-microtip-position="bottom-right" role="tooltip"
      ...
      <div class="mx-1.5" :aria-label="t('New File')" data-microtip-position="bottom" role="tooltip"
      ...
      <div class="mx-1.5" :aria-label="t('Rename')" data-microtip-position="bottom" role="tooltip"
      ...
      <div class="mx-1.5" :aria-label="t('Upload')" data-microtip-position="bottom" role="tooltip"
      ...
      <div class="mx-1.5" v-if="app.features.includes(FEATURES.ARCHIVE)" :aria-label="t('Archive')"
    ...
    <div class="flex text-center" v-else>
      ...
      <svg class="animate-spin p-0.5 h-5 w-5 text-white ml-auto" xmlns="http://www.w3.org/2000/svg" fill="none"
        viewBox="0 0 24 24" v-if="app.loading">
        <circle class="opacity-25 stroke-blue-900 dark:stroke-blue-100" cx="12" cy="12" r="10" stroke="currentColor"
    ...
    <div class="flex text-center items-center justify-end">
      <div v-if="app.features.includes(FEATURES.FULL_SCREEN)" class="mx-1.5" :aria-label="t('Toggle Full Screen')"
        data-microtip-position="bottom-left" role="tooltip" @click="toggleFullScreen">
        <svg xmlns="http://www.w3.org/2000/svg"
          class="h-6 w-6 md:h-8 md:w-8 m-auto cursor-pointer stroke-gray-500 hover:stroke-cyan-700 dark:stroke-gray-400 dark:hover:stroke-gray-300"
          fill="none" viewBox="0 0 24 24" stroke="none" stroke-width="1.5">
          <path v-if="app.fullScreen" stroke-linecap="round" stroke-linejoin="round"
      ...
      <div class="mx-1.5" :aria-label="t('Change View')" data-microtip-position="bottom-left" role="tooltip"
        ...
        <svg xmlns="http://www.w3.org/2000/svg"
          ...
          class="h-6 w-6 md:h-8 md:w-8 m-auto" fill="none" viewBox="0 0 24 24" stroke="none" stroke-width="1.5">
          <path v-if="app.view === 'grid'" stroke-linecap="round" stroke-linejoin="round"
            d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" />
          <path v-if="app.view === 'list'" stroke-linecap="round" stroke-linejoin="round"
...
const handleKeyDown = e => {
  switch (e.key) {
    case 'Delete':
      return (!selectedItems.value.length) || app.emitter.emit('vf-modal-show', { type: 'delete', items: selectedItems.value })
      break;
  }
}
